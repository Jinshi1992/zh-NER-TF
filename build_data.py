...
from module.data_utils import CoNLLDataset, get_vocabs, UNK, NUM, \
...
def main():
    ...
    # Generators
    dev   = CoNLLDataset("data_path/test_data", processing_word)
    test  = CoNLLDataset("data_path/test_data", processing_word)
    train = CoNLLDataset("data_path/train_data", processing_word)
