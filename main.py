...
parser.add_argument('--dropout', type=float, default=1.0, help='dropout keep_prob')
...
if args.mode == 'train':
    ...
    model.train(train=train_data_small, dev=test_data)  # use test_data as the dev_data to see overfitting phenomena
